...
-- 
-- Run with: wrangler d1 execute mafia-arena --remote --file=./migrations/0042_sync_direct_provider_models.sql
...
-- ============================================================================
-- MINIMAX MODELS (Direct API) - Missing from DB
-- ============================================================================

INSERT OR REPLACE INTO models (id, display_name, family, api_provider, api_model_id, config, supports_batch_pricing)
VALUES 
  ('minimax/MiniMax-M2.1', 'MiniMax-M2.1', 'minimax', 'minimax', 'MiniMax-M2.1', 
   '{"pricing":{"inputPer1K":0.0003,"outputPer1K":0.0012},"context_length":1000000}', 0),
  ('minimax/MiniMax-M2.1-lightning', 'MiniMax-M2.1-lightning', 'minimax', 'minimax', 'MiniMax-M2.1-lightning', 
   '{"pricing":{"inputPer1K":0.0003,"outputPer1K":0.0024},"context_length":204800}', 0);

-- ============================================================================
-- FIREWORKS MODELS (Direct API) - Ensure correct api_provider
-- ============================================================================

INSERT OR REPLACE INTO models (id, display_name, family, api_provider, api_model_id, config, supports_batch_pricing)
VALUES 
  ('fireworks/glm-4p7', 'GLM-4.7', 'glm', 'fireworks', 'accounts/fireworks/models/glm-4p7', 
   '{"pricing":{"inputPer1K":0.0006,"outputPer1K":0.0022},"context_length":198000}', 1),
  ('fireworks/deepseek-r1', 'DeepSeek R1', 'deepseek', 'fireworks', 'accounts/fireworks/models/deepseek-r1-0528', 
   '{"pricing":{"inputPer1K":0.00135,"outputPer1K":0.0054},"context_length":163840}', 1),
  ('fireworks/deepseek-v3', 'DeepSeek V3', 'deepseek', 'fireworks', 'accounts/fireworks/models/deepseek-v3p1', 
   '{"pricing":{"inputPer1K":0.0009,"outputPer1K":0.0009},"context_length":131072}', 1),
  ('fireworks/llama-3.1-8b', 'Llama 3.1 8B', 'meta', 'fireworks', 'accounts/fireworks/models/llama-v3p1-8b-instruct', 
   '{"pricing":{"inputPer1K":0.0002,"outputPer1K":0.0002},"context_length":131072}', 1);

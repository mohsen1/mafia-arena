...
export const openAIModels: ModelDefinition[] = [
  ...
  { title: "GPT-4.1 Mini (Default, Fast, API Optimized)", value: "gpt-4.1-mini" },
  { title: "GPT-4.1 Nano (Fastest, Cost-Effective, API Optimized)", value: "gpt-4.1-nano" },
  ...
  { title: "OpenAI o4-mini (Fast & Efficient Reasoning, Responses API, RFT)", value: "o4-mini" },
  ...
  { title: "GPT-3.5 Turbo Instruct (Legacy, Completions)", value: "gpt-3.5-turbo-instruct" },
];

// Updated Claude Models (Section 4 of the guide)
export const claudeModels: ModelDefinition[] = [
  // Claude 4 Series (Latest Generation)
  { title: "Claude 4 Sonnet (High Performance, Gen 4)", value: "claude-sonnet-4-20250514" },

  // Current Claude 3.x Series
  { title: "Claude 3.7 Sonnet (Default, Extended Thinking)", value: "claude-3-7-sonnet-20250219" },
  { title: "Claude 3.5 Sonnet (Intelligent, Upgraded)", value: "claude-3-5-sonnet-20241022" },
  { title: "Claude 3.5 Haiku (Fastest, Agile)", value: "claude-3-5-haiku-20241022" },
  { title: "Claude 3 Opus (Powerful, Complex Tasks)", value: "claude-3-opus-20240229" },
...
export const ollama_local: ModelDefinition[] = [
  ...
  { title: "Llama 3.1 (Meta, Gen Purpose, 8B Instr Q5_K_M)", value: "llama3.1:8b-instruct-q5_K_M" },
  { title: "Llama 3.1 (Meta, Gen Purpose, 70B Instr Q4_K_M)", value: "llama3.1:70b-instruct-q4_K_M" },
  { title: "Mistral (MistralAI, Fast, 7B Instruct v0.3)", value: "mistral:7b-instruct-v0.3" },
  { title: "Gemma 3 (Google, Efficient, 9B Instruct)", value: "gemma3:9b-it" },
  { title: "Qwen3 (Alibaba, General, 8B Chat Q5_K_M)", value: "qwen3:8b-chat-q5_K_M" },
  { title: "Phi-4 Mini (Microsoft, Small, Reasoning, 3.8B Q4_K_M)", value: "phi4-mini-reasoning:3.8b-q4_K_M" },
  { title: "Mixtral 8x7B (MistralAI, MoE, Instruct Q5_K_M)", value: "mixtral:8x7b-instruct-v0.1-q5_K_M" },

  // Coding Models
  { title: "Codellama (Meta, Coding, 7B Instruct Q5_K_M)", value: "codellama:7b-instruct-q5_K_M" },
  { title: "DeepSeek Coder V2 (DeepSeek, Adv Coding, 16B Q5_K_M)", value: "deepseek-coder-v2:16b-instruct-q5_K_M" },
  { title: "Devstral (Coding Agent, 24B Tools)", value: "devstral:24b-tools" },
  { title: "StarCoder2 (Coding, 3B)", value: "starcoder2:3b" },

  // Multimodal Models
  { title: "LLaVA (Vision-Language, Llama3 Base)", value: "llava-llama3:latest" },
  { title: "Qwen2.5 VL (Alibaba, Vision-Language)", value: "qwen2.5vl:latest" },
  { title: "Llama 4 (Meta, Multimodal, Latest Preview)", value: "llama4:latest" },

  // Specialized Models
  { title: "Nomic Embed Text (Embedding, Latest)", value: "nomic-embed-text:latest" },

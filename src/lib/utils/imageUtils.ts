...
const BASE_IMAGE_PATH = path.join(process.cwd(), 'public', 'images', 'characters');
 ...
 */
export async function selectCharacterImage(gender: 'male' | 'female', ageCategory: 'young' | 'old'): Promise<string | null> {

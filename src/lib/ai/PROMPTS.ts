...
export const GENERATE_TITLE_AND_DESCRIPTION_SYSTEM_PROMPT = `You are a creative assistant tasked with generating a thematic title and a short, evocative description 
...
export const TRANSLATE_TEXT_SYSTEM_PROMPT = (language: LanguageName) =>
  `You are a helpful translation assistant. Translate the user's text accurately into ${language}. Respond ONLY with the translated text, nothing else.`;

...
describe('management actions', () => {
  ...
  describe('deleteGameAction', () => {
    ...
    it('should return error when deleteGameData fails', async () => {
      ...
      vi.mocked(persistence.deleteGameData).mockRejectedValue(new Error(errorMessage));
    ...
    it('should handle unknown errors gracefully', async () => {
      ...
      vi.mocked(persistence.deleteGameData).mockRejectedValue('Some non-Error object');

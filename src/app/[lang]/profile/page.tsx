...
import { User, Mail, Calendar, Settings, Shield, ExternalLink } from 'lucide-react';
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <span className="text-sm font-medium text-foreground">{t('profile.accountType')}</span>
                    <div className="flex gap-2">
                      {user.email === 'dev@werewolf-ai.com' ? (
                        <Badge variant="secondary">{t('profile.developmentAccount')}</Badge>
                      ) : (
                        <Badge variant="default">{t('profile.standardAccount')}</Badge>
                      )}
                  ...
                  <div className="space-y-2">
                    <span className="text-sm font-medium text-foreground">{t('profile.memberSince')}</span>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <span className="text-sm font-medium text-foreground">{t('profile.authentication')}</span>
                  <div className="space-y-2">
                    {user.image?.includes('googleusercontent.com') && (
                      <Badge variant="outline" className="w-full justify-start">
                        <svg className="w-4 h-4 me-2" viewBox="0 0 24 24" aria-label="Google">
                          <title>Google</title>
                    ...
                    {user.image?.includes('githubusercontent.com') && (
                      <Badge variant="outline" className="w-full justify-start">
                        <svg className="w-4 h-4 me-2" fill="currentColor" viewBox="0 0 24 24" aria-label="GitHub">
                          <title>GitHub</title>
            ...
            <Card>
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>
                  {t('profile.aboutDescription1')}
                </p>
                <p>
                  {t('profile.aboutDescription2')}
                </p>
              </CardContent>
            </Card>
          </div>

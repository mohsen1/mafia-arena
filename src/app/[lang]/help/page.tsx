      ...
      <main className="max-w-4xl mx-auto p-4 space-y-8">
        <div className="mt-8">
          ...
          <p className="text-muted-foreground">
            {t(
              'help.subtitle',
              'Learn the rules and strategies for playing Werewolf with AI characters'
            )}
          </p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-secondary/30 p-4 rounded-lg">
              <h4 className="font-semibold mb-2">
                {t('help.overview.objective', 'Objective')}
              </h4>
              <ul className="list-disc list-inside space-y-1">
                <li>
                  {t(
                    'help.overview.villagerWin',
                    'Villagers win by eliminating all Mafia members'
                  )}
                </li>
                <li>
                  {t(
                    'help.overview.mafiaWin',
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {t(
                  'help.roles.villager.description',
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-sm space-y-1 ms-4">
                <li>
                  {t(
                    'help.phases.day.discussion',
                    'Players share observations and suspicions'
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.day.accusation',
                    'Players can accuse others of being Mafia'
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.day.voting',
                    'All alive players vote to eliminate one player'
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.day.elimination',
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-sm space-y-1 ms-4">
                <li>
                  {t(
                    'help.phases.night.mafia',
                    'Mafia members choose a Villager to eliminate'
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.night.seer',
                    "Seer investigates one player's alignment"
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.night.doctor',
                    'Doctor chooses one player to protect'
                  )}
                </li>
                <li>
                  {t(
                    'help.phases.night.reveal',
                    'Night results are revealed at dawn'
                  )}
                </li>
              </ul>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              <h4 className="font-semibold">
                {t('help.ai.features.title', 'AI Features')}
              </h4>
              <ul className="list-disc list-inside text-sm space-y-1 ms-4">
                <li>
                  {t(
                    'help.ai.features.personality',
                    'Unique personalities with period-appropriate names and backgrounds'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.features.memory',
                    'Remember previous discussions and player actions'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.features.strategy',
                    'Strategic thinking based on their role and game state'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.features.deduction',
                    'Logical deduction to identify suspicious behavior'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.features.deception',
                    'Mafia AI will lie and create false alibis'
                  )}
                </li>
              </ul>
            </div>
            ...
            <div className="bg-secondary/30 p-4 rounded-lg">
              <h4 className="font-semibold mb-2">
                {t('help.ai.tips.title', 'Tips for Playing with AI')}
              </h4>
              <ul className="list-disc list-inside text-sm space-y-1">
                <li>
                  {t(
                    'help.ai.tips.observe',
                    'Pay attention to AI voting patterns and accusations'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.tips.engage',
                    'Engage in discussions to gather information'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.tips.trust',
                    'Build trust with Villager AI to form alliances'
                  )}
                </li>
                <li>
                  {t(
                    'help.ai.tips.suspicious',
                    'Watch for inconsistencies in AI stories'
                  )}
                </li>
              </ul>
            </div>
          ...
          <CardContent className="space-y-4">
            <ol className="list-decimal list-inside space-y-2">
              <li>
                {t(
                  'help.start.step1',
                  'Click "Play Now" or "Start New Game" from the home page'
                )}
              </li>
              <li>
                {t(
                  'help.start.step2',
                  'Choose the number of players (4-10 recommended)'
                )}
              </li>
              <li>
                {t(
                  'help.start.step3',
                  'Select whether you want to join as a human player'
                )}
              </li>
              <li>
                {t(
                  'help.start.step4',
                  'Configure AI providers if you have API keys'
                )}
              </li>
